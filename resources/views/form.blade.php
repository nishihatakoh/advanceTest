      ...
      <form action="/form/check" method='POST'>
        ...
        <div class="item">
          ...
          <div class="gender-item">
            <input type="radio" name="gender" checked="checked"  value="1" class="radio"><label class="gender">男性</label>
        ...
        <div class="item">
          ...
          <div class="input">
            <input type="email" name="email" value="{{old('email')}}" class="input_item" required>
        ...
        <div class="item">
          ...
          <div class="input_postcode">
            <p>〒</p>
            <div>
              <input type="text" name="postcode" onKeyUp="AjaxZip3.zip2addr(this,'','address','address');" value="{{old('postcode')}}" class="input_item" required>
        ...
        <div class="item">
          ...
          <div class="input">
            <input type="text" name="address" value="{{old('address')}}" class="input_item" required>
        ...
        <div class="item">
          ...
          <div class="input">
            <input type="text" name="building_name"value="{{old('building_name')}}" class="input_item">
        ...
        <div class="item">
          ...
          <textarea name="opinion" cols="30" rows="6" class="input" required>{{ old('opinion') }}</textarea>
        </div>
